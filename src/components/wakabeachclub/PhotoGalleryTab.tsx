    ...
    <div className="space-y-12">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between border-b border-neutral-200/60 pb-6 text-left gap-4">
        <div className="space-y-1">
          <span className="text-[10px] font-mono font-bold tracking-[0.3em] text-[#bca986] uppercase block">
            Visual Journal
          </span>
        ...
        <p className="text-[11px] text-neutral-500 font-light leading-relaxed max-w-sm md:text-right">
          Curated photographic moments along pristine shores, tranquil waters,
          and the timeless coastal beauty of Bali at Waka Beach Club.
        </p>
      </div>
